        ...
        <div className="w-full relative min-h-screen">
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    >
                        <MapPin size={18} /> Location: {isRemote ? 'Remote Only' : 'Global / All'}
                    </button>
                </div>
            </div>
                            ...
                            >
                                ...
                                <div className="flex-1 flex flex-col">
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-xs text-slate-600 dark:text-slate-400 mb-3">
                                        ...
                                        <div className="flex items-center gap-1">
                                            <MapPin size={12} className="text-green-500" /> {hack.location || (isRemote ? 'Remote' : 'Global')}
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-auto flex items-center gap-2">
                                        <a 
                                            ...
                                            target="_blank" 
                                            rel="noreferrer"
                                            className="px-3 py-1.5 bg-slate-100 dark:bg-white/10 text-slate-900 dark:text-white text-xs font-bold rounded-lg hover:bg-slate-200 dark:hover:bg-white/20 transition-colors flex items-center gap-1"
                                        >
                                ...
                                <div className="space-y-3">
                                    ...
                                    {squad.map((member, idx) => (
                                        <div key={member._id || idx} className="p-4 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-white/10 flex items-center justify-between">
                                            ...
                                            <button 
                                                onClick={() => {
                                                    toast.success(`Invite sent to ${member.name}! Check your email shortly.`);
                                                }}
