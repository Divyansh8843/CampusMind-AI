                                    ...
                                    <div className="flex items-start gap-4 mb-4">
                                        <div className="relative w-12 h-12 shrink-0">
                                            <img 
                                                ...
                                                alt={job.company}
                                                className="w-12 h-12 rounded-xl object-contain bg-white border border-slate-100"
                                                onError={(e) => {
                                                    e.target.onerror = null;
                                                    let domain = job.source.toLowerCase().replace(/\s+/g, '') + '.com';
                                                    if(job.source === 'WeWorkRemotely') domain = 'weworkremotely.com';
                                                    if(job.source === 'RemoteOK') domain = 'remoteok.com';
