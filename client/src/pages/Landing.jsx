...
import HeroLiveStats from "../components/HeroLiveStats";
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-white font-sans selection:bg-blue-500/30 transition-colors duration-300 relative">
      ...
      <section className="relative pt-32 pb-20 lg:pt-24 lg:pb-32 overflow-hidden">
        <div className="absolute inset-0 bg-slate-900/5 opacity-20"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div>
            ...
            <p className="max-w-2xl mx-auto text-xl text-slate-600 dark:text-slate-400 mb-10 leading-relaxed">
              India-wide AI platform for students and alumni. Smart study,
              AI alumni verification, live network map, resume analysis, mock
      ...
      <section
        id="how-it-works"
        className="py-24 bg-slate-50 dark:bg-slate-900/50 border-t border-slate-200 dark:border-white/5"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
              Transforming your study materials into an intelligent knowledge
              base in three simple steps.
            </p>
          </div>
            ...
            {[
              {
                ...
                icon: FileText,
                desc: "Upload PDFs and notes. Files immediately go to your private, self-hosted vault.",
              },
              {
                title: "Local Vector Index",
                icon: Layers,
                desc: "Our offline ML models automatically chunk and index your content into ChromaDB.",
              },
              {
                title: "Agentic Learning",
                icon: Brain,
                desc: "Chat with the local LLM to get instant answers drawn perfectly from your vectors.",
              },
            ].map((step, idx) => (
              <div
                key={idx}
      ...
      <section
        id="features"
        className="py-24 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-white/5"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4 text-slate-900 dark:text-white">
            ...
            <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
              Powered by pure Local ML and GenAI RAG Fundamentals. Zero reliance
              on OpenAI or external APIs. Total privacy, maximum power.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className="p-8 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/5 hover:border-blue-500/30 transition-all hover:bg-white dark:hover:bg-white/10 hover:shadow-xl dark:hover:shadow-none"
              >
        ...
        <div className="max-w-3xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 dark:text-slate-400">
              Common questions about CampusMind AI.
            </p>
          </div>
          ...
          <div className="space-y-4">
            {[
              {
                q: "Is my data sent to OpenAI or ChatGPT?",
                a: "NO. CampusMind AI operates on a strictly 100% Local Agentic ML foundation. We use sovereign locally-hosted models (like Ollama and HuggingFace vectors). Your data never touches a 3rd party API.",
              },
              {
                q: "How do the Mock Interviews work?",
                a: "Our AI assumes the role of a strict FAANG/MNC Senior Engineer. It expects deep domain knowledge, code optimization, and highly specific algorithm logic in a real-time voice setting.",
              },
              {
                q: "Is the job/hackathon data real?",
                a: "Yes. Our platform uses live scrapers to aggregate the newest tech opportunities and hackathons globally, right as they are posted on sites like Unstop or Internshala.",
              },
              {
                q: "How does the AI Study RAG work?",
                a: "When you upload a PDF, we locally vectorize the data into ChromaDB. When you chat, our Agentic Engine accesses those EXACT mathematical vectors to guarantee zero hallucinations.",
              },
            ].map((faq, i) => (
              <details
                key={i}
                className="group bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-white/10 overflow-hidden"
              >
      ...
      <section className="py-16 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-white/5">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold mb-8 text-slate-900 dark:text-white flex items-center justify-center gap-2">
            <Globe size={24} className="text-blue-500" /> Trusted by Students
            Worldwide
          </h2>
          <div className="flex flex-wrap justify-center gap-8 text-slate-500 dark:text-slate-400">
            <span className="flex items-center gap-2">
              <CheckCircle size={18} className="text-green-500" /> Secure
              Payments
            </span>
            <span className="flex items-center gap-2">
              <CheckCircle size={18} className="text-green-500" /> Real-time AI
            </span>
            <span className="flex items-center gap-2">
              <CheckCircle size={18} className="text-green-500" /> No Hidden
              Fees
            </span>
            <span className="flex items-center gap-2">
              <CheckCircle size={18} className="text-green-500" /> Easy Sign-up
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden">
        <div className="absolute inset-0 bg-slate-900/5 opacity-10"></div>
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">
            Ready to Transform Your Academic Journey?
          </h2>
          <p className="text-blue-100 text-lg mb-8 max-w-2xl mx-auto">
            Join students worldwide. Pay once, unlock unlimited AI. Experience
            the power of AI-driven education today.
          </p>
          {isLoggedIn ? (
            <NavLink
              to={user?.role === "admin" ? "/admin" : "/dashboard"}
