            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center h-16 relative">
                    ...
                    <div className="flex-shrink-0 flex items-center justify-start gap-2 mr-auto">
                        <NavLink to={!isLoggedIn ? "/" : (user?.role === 'admin' ? "/admin" : user?.role === 'alumni' ? "/alumni" : "/dashboard")} className="flex items-center gap-2 group">
                        ...
                        {isLoggedIn && (
                            <>
                                {user?.role === 'admin' ? (
                                    ...
                                    <>
                                        <LinkItem to="/alumni" isRouterLink>Dashboard</LinkItem>
                                    </>
                                ) : (
                                    <>
                                        ...
                                        <LinkItem to="/alumni" isRouterLink>Alumni</LinkItem>
                                    </>
                                )}
                            </>
                        )}
                            ...
                            <div className="relative group">
                                ...
                                <div className="absolute right-0 mt-2 w-56 py-2 bg-white dark:bg-slate-900 rounded-xl shadow-xl border border-slate-100 dark:border-white/10 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all transform origin-top-right">
                                    ...
                                    <div className="py-1">
                                        ...
                                        {user?.role === 'student' && (
                                            <>
                                                <NavLink to="/syllabus" className="block px-4 py-2 text-sm text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-white/5">
                                                    Syllabus Tracker
                                                </NavLink>
                                                <NavLink to="/alumni" className="block px-4 py-2 text-sm text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-white/5">
                                                    Alumni Network
