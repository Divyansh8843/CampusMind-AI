...
router.get("/me", authMiddleware, async (req, res) => {
    try {
        ...
        // Parallel Fetch
        const [user, resumeCount, interviewCount, chatCount, interviewSum] = await Promise.all([
            User.findById(userId).select("usage subscription xp branch resumeDocumentId"),
        ...
        const docCount = await Document.countDocuments(
            buildStudyDocumentQuery(userId, user?.resumeDocumentId)
        );
